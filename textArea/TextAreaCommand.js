...
export default class TextAreaCommand extends Command{
  ...
  constructor(editor, fields, modelElementName, modelLabel=''){
	...
	refresh() {
        ...
        const textElement = element && element.getChild(0);
        values['value'] = textElement && textElement.data || '';
		this.value = values;
	} 
	...
	execute( formdata ) {
		...
		this.editor.model.change( writer => {
			...
			const textNode = writer.createText( formdata.value );
